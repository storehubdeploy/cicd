...
if __name__ == "__main__":
    baseurl = "https://chatserver.k8s.shub.us/storehub?source=jenkins&group_id=t_4351654104886278"
    ...
    message = "the job {} in env {} merge branch master to release with conflicts".format(args.job, args.env)
